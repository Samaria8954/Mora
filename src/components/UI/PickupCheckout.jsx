                    ...
                    <TabContext value={value}>
                                ...
                                <div className="checkout-11">
                                    ...
                                    <div className="identity mb-3">
                                        ...
                                        <Checkbox
                                            ...
                                            icon={<CheckBoxOutlineBlankIcon sx={{ fontSize: "2.5rem", color: "#6B0572" }} />}
                                            checkedIcon={<CheckBoxIcon sx={{ fontSize: "2.5rem", color: "#6B0572" }} />}
                                            sx={{
                                                "& .MuiSvgIcon-root": { fontSize: "2.5rem", color: "#6B0572" },
                                            }}
                                        />
                                    </div>
                                    <div class="alert">
                        ...
                        <TabPanel value="3">
                            <div className="complete">
                                ...
                                <div className="order-now mt-2 " style={{width:"220px" , margin:"auto"}}>
                                    <button type="button" onClick={() => { navigate("/collection"); window.scrollTo({ top: 0, behavior: "smooth" }); }} >Continue Shopping</button>
                                </div>
                            </div>
                        </TabPanel>
                    </TabContext>
